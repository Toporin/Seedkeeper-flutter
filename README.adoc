== Seedkeeper PRO Manager for Desktop and Android

NOTE: This is a community fork of Yubico's https://github.com/Yubico/yubioath-flutter[Yubioath-Flutter application], adapted to manage Seedkeeper PRO devices instead of YubiKeys.

image:splash.png[]

Manage your passkeys and access one-time passwords with this full-featured
companion app to the Seedkeeper PRO.

=== Features include
* Display information about your device such as firmware version,
...
Seedkeeper PRO Manager you can raise the bar for security. No
connectivity needed!

Experience security the modern way with the Seedkeeper PRO Manager.
Visit https://seedkeeper.io to learn more.
...
communicate with a Seedkeeper over the SmartCard interface.
...
This app is based on the https://github.com/Yubico/yubioath-flutter[Yubioath-Flutter application] by Yubico.