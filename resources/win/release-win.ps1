...
signtool.exe sign /sha1 a1614cd84976030d49209b56162d9efa69b73698 /d "Seedkeeper PRO" /fd SHA256 /t http://timestamp.digicert.com/scripts/timstamp.dll yubico-authenticator-$version-win64.msi
